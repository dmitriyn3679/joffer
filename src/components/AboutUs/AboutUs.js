        ...
        <Box className={classes.aboutWrapper}>
          <Box className={classes.info}>
            ...
            <Text className={classes.description}>
              ...
              Наша мета — дати людям можливість попрацювати над реальним проєктом: таск-менеджери, git, мітинги, код-рев'ю та фідбек. І звичайно ж — підтримку, підготовку до інтервʼю та допомогу з CV.
